...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=HP;Database=NORTHWND;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrdersAvg>(ord =>
            {
                ord.HasNoKey();

                ord.ToView("OrdersAvg");
                ord.Property(p => p.ShipCountry).HasColumnName("ShipCountry");
                ord.Property(p => p.ShipCountry).HasColumnType("NVARCHAR(250)");
                ord.Property(p => p.AvgFreight).HasColumnName("AvgFreight");
                ord.Property(p => p.AvgFreight).HasColumnType("DOUBLE");
